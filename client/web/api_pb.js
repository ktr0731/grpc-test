...
proto.api.UnaryMessageRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(1, f, proto.api.Name.serializeBinaryToWriter);
  }
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.api.UnaryRepeatedMessageRequest.toObject = function (includeInstance, msg) {
    var f,
        obj = {
      nameList: jspb.Message.toObjectList(msg.getNameList(), proto.api.Name.toObject, includeInstance)
    };
...
proto.api.UnaryRepeatedMessageRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.api.Name.serializeBinaryToWriter);
  }
};
/**
...
proto.api.UnaryMapMessageRequest.prototype.getKvsMap = function (opt_noLazyCreate) {
  return (
    /** @type {!jspb.Map<string,!proto.api.Name>} */
    jspb.Message.getMapField(this, 1, opt_noLazyCreate, proto.api.Name)
  );
};
...
proto.api.UnaryOneofRequest.prototype.getNameCase = function () {
  return (
    /** @type {proto.api.UnaryOneofRequest.NameCase} */
    jspb.Message.computeOneofCase(this, proto.api.UnaryOneofRequest.oneofGroups_[0])
  );
};
